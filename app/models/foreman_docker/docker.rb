...
module ForemanDocker
  class Docker < ::ComputeResource
    ...
    def self.get_container(container)
      conn = container.compute_resource.connection
    ...
    def local_images(filter = '')
      ::Docker::Image.all({ 'filter' => filter }, connection)
    end
    ...
    def exist?(name)
      ::Docker::Image.exist?(name, {}, connection)
    end
    ...
    def search(term = '')
      ::Docker::Image.search({ :term => term }, connection)
    end
    ...
    def create_container(args = {})
      ...
      docker_command do
        ::Docker::Container.create(options, connection)
      end
    end
    ...
    def create_image(args = {})
      ...
      docker_command do
        ::Docker::Image.create(args, credentials, connection)
      end
    end
    ...
    def console(uuid)
      test_connection
      container = ::Docker::Container.get(uuid, {}, connection)
      {
